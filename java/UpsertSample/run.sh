...
APPNAME="upsertsample"
SOURCEPATH="com/voltdb/upsert"
...
function async-benchmark-help() {
    srccompile
    java -classpath obj:$CLASSPATH:obj com.voltdb.upsert.UpsertSample --help
}

function async-benchmark() {
    srccompile
    java -classpath obj:$CLASSPATH:obj com.voltdb.upsert.UpsertSample \
        --duration=120 \
        --servers=localhost
}
